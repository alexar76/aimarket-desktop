...
Capability Composer is a Flutter desktop app (macOS / Windows / Linux) that lets you visually discover, chain, and sell AI capabilities from the [AI Market Protocol](https://github.com/alexar76/aimarket-protocol) marketplace. It is the Tier 4 meta-product that makes the economy itself more usable.
...
```dart
final agent = AimarketAgent(hubUrl: 'https://modelmarket.dev', walletKey: key);
