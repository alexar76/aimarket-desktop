...
class PipelineState extends ChangeNotifier {
  ...
  // ── Connection ──
  String _hubUrl = 'https://modelmarket.dev';
  String? _walletKey;
...
class PipelineCanvas extends StatelessWidget {
          ...
          floatingActionButton: pipeline != null
              ? FloatingActionButton.small(
                  onPressed: () => state.addNode(
                    Capability(
                      capabilityId: 'node-${DateTime.now().millisecondsSinceEpoch}',
                      productId: 'custom',
                      name: 'New Capability',
                      version: '1.0',
  ...
  void _showConnectDialog(BuildContext context) {
    final urlController = TextEditingController(text: 'https://modelmarket.dev');
        ...
        content: Column(
          ...
          children: [
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Hub URL',
                hintText: 'https://modelmarket.dev',
              ),
            ),
